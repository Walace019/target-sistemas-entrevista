...
public class QuestaoQuatro {
    public static void main(String[] args) {
        ...
        a uma velocidade constante de 110 km/h e o caminhão de Franca em direção a Ribeirão Preto a uma
...
c)  Explique como chegou no resultado.
     ...
     /* Não sei responder essa questão , mas só pelo fato do carro ter um sem separar e não perder 5 minutos em um pedágio
        ele provavelmente chegará primeiro */
